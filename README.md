...
Evaluating expressions at runtime is a valuable tool to allow formulas and other calculations to be customized post installation, which otherwise would require a physical update or a custom build of the application.  Any application designed to calculate and manage a sales compensation plan are good candidates for Codeblocks, where the end-customer may want to customize the forumulas for their product mix and goals. 
