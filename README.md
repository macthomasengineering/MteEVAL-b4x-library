...
MteEval adopts the "code block" format from the venerable 1990's xBase compiler Clipper 5.X.  A codeblock is a compilable snippet of code.  The codeblock begins with an open bracket,  followed by a parameter section between pipe symbols, the expression, the ends with a closing bracket.
