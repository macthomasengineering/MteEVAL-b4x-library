...
MteEval adopts the "code block" format for specifying expressions from the venerable 1990's xBase compiler Clipper 5.X.  A codeblock is a compilable snippet of code.  The codeblock begins with an open bracket, followed by a parameter section between pipe symbols, the expression, then ends with a closing bracket.
